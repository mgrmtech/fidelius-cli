...
The examples folder can be perused for guidance on integrating Fidelius CLI with Node JS, Python, and PHP codebases. They can be run with following commands. 
